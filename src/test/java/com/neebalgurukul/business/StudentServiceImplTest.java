...
import com.neebalgurukul.java.StudentServiceStub;
import com.neebalgurukul.model.Student;

public class StudentServiceImplTest {

    @Test
    public void testGetStudentStartWithA() {

	StudentServiceStub stub = new StudentServiceStub();
	int expectedOutput = 2;

	List<Student> list = stub.getAllStudents();
	...
	assertEquals(expectedOutput, studServiceImpl.getStudentStartwithA().size());
